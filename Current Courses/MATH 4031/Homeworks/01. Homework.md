...
Now, recognize that $\text{gcd}(m,\;n)=1$ and that $\big(\frac{m}{n}\big)^{2}=2$ simplifies to $m^2=2n^2$. The RHS is therefore even, and the LHS tells us that the RHS is a perfect squ