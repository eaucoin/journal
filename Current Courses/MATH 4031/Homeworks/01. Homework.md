...
Part **(b)** can be observed with the fundamental theorem of arithmetic: $m$ is of the form $p_1^{\alpha_1}p_1^{\alpha_2}\dots p_n^{\alpha_n}$, then $m^2$ is of the form $p_1^{2\alpha_1}p_1^{2\alpha_2}\dots p_n^{\alpha_n}$