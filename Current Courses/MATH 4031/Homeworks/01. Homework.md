...
**1.10)** If $$\begin{pmatrix}a&b&c&d\end{pmatrix}=\begin{pmatrix}1&2&1&2\end{pmatrix}\text{,}$$ then $a-c=0$ and $b-d=0$. If $\begin{pmatrix}a&b&c&d\end{pmatrix}=\begin{pmatrix}2&1&2&1\end{pmatrix}$$ then 
