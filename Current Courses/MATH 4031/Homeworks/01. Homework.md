...
**1.11)** An odd integer is of the form $2k+1$, where $k\in\mathbb{Z}$. Such an integer squared is of the form $2(2k^2+2k)+1$. Since the integers are closed under multiplication and addition, $2k^2+2k$ is an integer, so our original odd integer is of the form 