...
**1.07)** For all $a$, $b$, and $c$ in $\mathbb{R}$, we know that $a-b$ and $b-c$ are in $\mathbb{R}$. Therefore, we can apply the triangle to both $a-b$ and $b-c$ as they are real numbers. Applied:
$$\begin{align*}
