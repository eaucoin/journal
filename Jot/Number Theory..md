I'll OCR this math packet, using markdown for text and LaTeX for mathematical expressions. I'll start with the first page and work through systematically.
