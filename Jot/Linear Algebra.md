...
Now, we have a strong descriptive footing to describe complex vectors and matrices efficiently. The *conjugate transpose* of a matrix or a vector in $$(a_{ij}+ib_{ij})_{m\times n}\in \mathbb{C}^{m\times n}$
