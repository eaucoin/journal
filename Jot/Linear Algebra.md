...
With our inner product space defined, we can now describe length in $\mathbb{C}^n$. For a vectors in $\mathbb{rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr}$